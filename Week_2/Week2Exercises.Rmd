...
Here I used str_count to find the indices of the word 'table' in the Product.Name column of sales. I then used sum to count the total number of occurrences. 
